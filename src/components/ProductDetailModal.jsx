        ...
        <div className="border-t border-gray-200 bg-gray-50 p-4 sm:p-8 space-y-6 text-xs text-left">
          ...
          <div className="flex border-b border-gray-200 gap-6 font-bold">
            ...
            <button
              ...
              className={`pb-2.5 border-b-2 transition ${activeTab === 'reviews' ? 'border-[#3B429F] text-[#3B429F]' : 'border-transparent text-gray-500'}`}
            >
          ...
          {activeTab === 'reviews' && (
            <div className="space-y-4">
              {product.reviews.map(rev => (
                <div key={rev.id} className="bg-white p-4 rounded-xl border border-gray-200 space-y-2">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className="w-7 h-7 rounded-full bg-indigo-100 text-[#3B429F] font-bold flex items-center justify-center">
                        {rev.author[0]}
                      </div>
